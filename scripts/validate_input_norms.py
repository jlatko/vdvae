...
def main():
    ...
    print("raw_xs", raw_xs.mean(), raw_xs.var(), raw_xs.min(), raw_xs.max())
    print("inputs", inputs.mean(), inputs.var(), inputs.min(), inputs.max())
    print("targets", targets.mean(), targets.var(), targets.min(), targets.max())
